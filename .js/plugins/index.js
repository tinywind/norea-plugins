...
var githubdocs_1 = __importDefault(require("@plugins/multi/githubdocs"));
var komga_1 = __importDefault(require("@plugins/multi/komga"));
var oapen_1 = __importDefault(require("@plugins/multi/oapen"));
var PLUGINS = [contenttypefixture_1.default, projectgutenberg_1.default, standardebooks_1.default, aozorabunko_1.default, githubdocs_1.default, komga_1.default, oapen_1.default];
